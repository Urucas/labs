...
function _app() {
	...
	this.charactersList = [
		{ src: "http://urucas.com/labs/halloween/img/cat.png", id:"cat"},
		{ src: "http://urucas.com/labs/halloween/img/titi.png", id:"titi"},
		{ src: "http://urucas.com/labs/halloween/img/pumpking.png", id:"pumpking"},
		{ src: "http://urucas.com/labs/halloween/img/skull.png", id:"skull"},
		{ src: "http://urucas.com/labs/halloween/img/moon.png", id:"moon"},
		{ src: "http://urucas.com/labs/halloween/img/hat.png", id:"hat"},
		{ src: "http://urucas.com/labs/halloween/img/bat.png", id:"bat"},
		{ src: "http://urucas.com/labs/halloween/img/escoba.png", id:"escoba"},
	]
	this.selected = null;
	...
	this.postFB = function() {
		...
		FB.ui({
			method: 'feed',
			name: "Halloween",
			link: "http://urucas.com/labs/halloween/",
			picture: document.getElementById("generatedimg").src,
			message: "Mi foto Halloween",
		},    
		function (response) {
